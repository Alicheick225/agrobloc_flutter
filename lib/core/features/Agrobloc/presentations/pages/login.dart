...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // Initialize emailController with prefillIdentifiant if profile is acheteur
    emailController = TextEditingController(
      text: widget.prefillIdentifiant ?? '',
    );
    // Initialize passwordController with prefillPassword if provided
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // TODO: Naviguer vers la page principale de l'application
    } catch (e) {
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => SignUpPage(profile: widget.profile)),
                          );
                        },
                        child: const Text(
                          "Inscrivez-vous ici !",
