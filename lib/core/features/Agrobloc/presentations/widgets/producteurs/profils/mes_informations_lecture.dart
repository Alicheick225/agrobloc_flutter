...
class MesInformationsEdition extends StatefulWidget {
  const MesInformationsEdition({super.key});

  @override
  State<MesInformationsEdition> createState() => _MesInformationsEditionState();
}

// L'état est maintenant nommé _MesInformationsEditionState
class _MesInformationsEditionState extends State<MesInformationsEdition> {
